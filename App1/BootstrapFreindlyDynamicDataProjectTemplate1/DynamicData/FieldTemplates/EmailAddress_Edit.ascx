<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EmailAddress_Edit.ascx.cs" Inherits="BootstrapFreindlyDynamicDataProjectTemplate1.EmailAddress_EditField" %>
